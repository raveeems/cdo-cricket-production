...
### Player Headshot Images (CSK complete + RCB complete + SRH complete + MI complete — 99 players total)
...
- **Coverage**:
  ...
  - SRH (25 players, complete) — Batch 1 (19): Abhishek Sharma, Amit Kumar, Aniket Verma, Brydon Carse, Eshan Malinga, Harshal Dubey, Harshal Patel, Heinrich Klaasen, Ishan Kishan, Jack Edwards, Jaydev Unadkat, Kamindu Mendis, Krains Fuleta, Liam Livingstone, Nitish Kumar Reddy, Onkar Tukaram, Pat Cummins, Praful Hinge, Sakib Hussain. Batch 2 (6): Salil Arora, Shivam Mavi, Shivang Kumar, Smaran Ravichandran, Travis Head, Zeeshan Ansari
  - MI (25 players, complete) — Batch 1 (19): AM Ghazanfar, Ashwani Kumar, Atharva Ankolekar, Corbin Bosch, Danish Malewar, Deepak Chahar, Hardik Pandya, Jasprit Bumrah, Mayank Markande, Mayank Rawat, Mitchell Santner, Mohammed Salahuddin, Naman Dhir, Quinton de Kock, Raghu Sharma, Raj Bawa, Robin Minz, Rohit Sharma, Ryan Rickelton. Batch 2 (6): Shardul Thakur, Sherfane Rutherford, Suryakumar Yadav, Tilak Varma, Trent Boult, Will Jacks
...
- **Extending**: To add more teams (DC, KKR, etc.), append new entries to `PLAYER_IMAGES` in `utils/playerImages.ts` with the player's API UUID as key and a `require('../assets/images/players/{id}.jpeg')` as value. Add corresponding JPEG to `assets/images/players/`.