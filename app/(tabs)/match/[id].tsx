...
export default function MatchDetailScreen() {
  ...
  const canEdit = canEditTeam(match.startTime, match.status, match.revisedStartTime, match.adminUnlockOverride, match.firstScorecardAt);
  ...
  const renderMyTeamsSection = () => (
    <>
      ...
      {previewTeamId && (() => {
        ...
        const previewPrimaryImpact: PitchPlayer | null = (() => {
          ...
          if (!p) return null;
          return { id: p.id, name: p.name, role: p.role as 'WK'|'BAT'|'AR'|'BOWL', points: p.points || 0, teamShort: p.teamShort, externalId: (p as any).externalId, isPlayingXI: !!p.isPlayingXI, isImpactPlayer: !!p.isImpactPlayer, isImpactActivated: !!(p as any).isImpactActivated };
        })();
        ...
        return (
          <TeamPitchView
            ...
            impactPlayer={previewPrimaryImpact}
            backupPlayer={previewBackupImpact}
          ...
          return (
            ...
            >
              ...
              {expandedTeamId === entry.teamId && (() => {
                ...
                const entryPool = [...(entry.resolvedPlayers || []), ...allKnownPlayers];
                const entryPrimaryImpact: PitchPlayer | null = (() => {
                  if (!entry.primaryImpactId) return null;
                  const p = entryPool.find(pl => pl.id === entry.primaryImpactId);
                  if (!p) return null;
                  return { id: p.id, name: p.name, role: p.role as 'WK'|'BAT'|'AR'|'BOWL', points: (p.points || 0), teamShort: (p as any).teamShort, externalId: (p as any).externalId, isPlayingXI: !!(p as any).isPlayingXI, isImpactPlayer: !!(p as any).isImpactPlayer, isImpactActivated: !!(p as any).isImpactActivated };
                })();
                ...
                return (
                  <View style={{ marginTop: 10, width: '100%' }}>
                    <TeamPitchView
                      ...
                      matchCompleted={match.status === 'completed'}
                      team1Short={match.team1Short}
                      impactPlayer={entryPrimaryImpact}
                      backupPlayer={entryBackupImpact}
              ...
              <View style={styles.participantHeader}>
                <View style={styles.participantInfo}>
                  <UserAvatar
                    ...
                    size={36}
                    backgroundColor={isCurrentUser ? colors.accent + '20' : colors.primary + '20'}
                    textColor={isCurrentUser ? colors.accent : colors.primary}
                    fontSize={14}
                    fontFamily="Inter_700Bold"
                  />
                  <View>
                  ...
                  >
                    ...
                    {isExpanded && teamPlayers.length > 0 && (() => {
                      ...
                      const participantPrimaryImpact: PitchPlayer | null = (() => {
                        ...
                        if (!p) return null;
                        return { id: p.id, name: p.name, role: p.role as 'WK'|'BAT'|'AR'|'BOWL', points: p.points || 0, teamShort: p.teamShort, externalId: (p as any).externalId, isPlayingXI: !!(p as any).isPlayingXI, isImpactPlayer: !!(p as any).isImpactPlayer, isImpactActivated: !!(p as any).isImpactActivated };
                      })();
                      ...
                      return (
                        <View style={{ marginTop: 10 }}>
                          <TeamPitchView
                            ...
                            matchCompleted={match.status === 'completed'}
                            team1Short={match.team1Short}
                            impactPlayer={participantPrimaryImpact}
                            backupPlayer={participantBackupImpact}
